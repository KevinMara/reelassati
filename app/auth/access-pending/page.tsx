...
import { Clock, Globe, Sun, Moon, ArrowLeft } from "lucide-react";
...
// Access Pending Page Component
export default function AccessPendingPage() {
  return (
    <AuthWrapper
      title="Grazie. Rilassati."
      sub="Stiamo dando un'occhiata alla tua richiesta."
    >
      <div className="space-y-6 text-center">
        <div className="flex justify-center">
          <div className="h-16 w-16 rounded-full bg-[#5E4BC6]/10 text-[#5E4BC6] flex items-center justify-center">
            <Clock className="h-8 w-8" />
          </div>
        </div>
        <p className="text-foreground/70 leading-relaxed">
          I piani a pagamento passano da una revisione manuale. Ti mandiamo un'email appena il tuo account è attivo — di solito in meno di 24 ore.
        </p>
        <button
