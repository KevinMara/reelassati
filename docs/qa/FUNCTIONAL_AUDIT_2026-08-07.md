...
| `/pricing`              | Honest current availability and private-beta billing state                                 | No fake checkout or plan activation.                                                          |
...
| `/dashboard/referral`  | Code creation/share/copy/claim, pending/verified history                                                                                                            | False active-billing implication removed. Qualification requires a signed, recent, idempotent server webhook; private-beta rewards remain visibly pending.                                            |
...
- Refer & Earn no longer states that private-beta purchases can already be
