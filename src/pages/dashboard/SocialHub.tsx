    ...
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-border bg-surface p-5">
          ...
          <p className="text-sm text-foreground/70">Connected accounts</p>
        </div>
        <div className="rounded-xl border border-border bg-surface p-5">
          <p className="text-3xl font-semibold">{connectedPlatforms.size}</p>
          <p className="text-sm text-foreground/70">Active platforms</p>
        </div>
        <div className="rounded-xl border border-border bg-surface p-5">
          <p className="text-sm font-medium">
            {lastSyncedAt
          ...
          <p className="mt-1 text-sm text-foreground/70">Last account sync</p>
        </div>
      </div>

      {workspace.accounts.length > 0 && (
        <section className="mb-10">
          <h2 className="mb-4 text-xs font-semibold uppercase tracking-[0.16em] text-foreground/70">
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-3">
                      <div
                        className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-xs font-bold text-white ${meta.badge}`}
                      >
                        {meta.mark}
                      </div>
                  ...
                  <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-xs text-foreground/70 transition-colors hover:bg-red-500/10 hover:text-red-500 disabled:opacity-40"
                    >
            ...
            return (
              ...
              >
                <div className="mb-4 flex items-center gap-3">
                  <div
                    className={`flex h-9 w-9 items-center justify-center rounded-lg text-xs font-bold text-white ${meta.badge}`}
                  >
                    {meta.mark}
                  </div>
                  <div>
