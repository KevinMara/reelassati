  ...
  en: [
    {
      ...
      description:
        "Trim, split, reorder, caption, lock, and inspect the exact interval you are changing. Manual control remains available at every step.",
      status: "Studio",
    ...
    },
    {
      ...
      description:
        "Proposed edits show the interval, action, and reason before they touch the timeline. Approve changes one by one or reject the plan.",
      status: "Studio",
      icon: BrainCircuit,
    },
    {
    ...
    },
    {
      ...
      description:
        "Turn a brief into production-aware direction with camera, subject, lighting, audio, timing, and negative constraints—not a vague one-line prompt.",
      status: "10 presets",
      icon: Sparkles,
    },
    {
      ...
      description:
        "Save checkpoints, compare directions, and keep a clear path back. Exploration should never destroy the cut you already trust.",
      status: "Workspace",
      icon: History,
    },
    {
      ...
      description:
        "Map retention and skips back to exact edit decisions, then draft a more informed V2. This learning loop is visible product roadmap—not a current claim.",
      status: "Roadmap",
      icon: LineChart,
    },
  ],
  it: [
    {
      ...
      description:
        "Taglia, dividi, riordina, sottotitola, blocca e ispeziona l’intervallo esatto che stai cambiando. Il controllo manuale resta sempre disponibile.",
      status: "Studio",
      icon: SlidersHorizontal,
    },
    {
      ...
      description:
        "Ogni modifica proposta mostra intervallo, azione e motivo prima di toccare la timeline. Approva una voce alla volta o rifiuta il piano.",
      status: "Studio",
      icon: BrainCircuit,
    },
    {
    ...
    },
    {
      title: "Prompt Director",
      description:
        "Trasforma un brief in direzione produttiva: camera, soggetto, luce, audio, timing e vincoli negativi, non una riga generica.",
      status: "10 preset",
      icon: Sparkles,
    },
    {
      ...
      description:
        "Salva checkpoint, confronta direzioni e conserva una strada chiara per tornare indietro. Esplorare non deve distruggere il montaggio buono.",
      status: "Workspace",
      icon: History,
    },
    {
      title: "Performance → timeline",
      description:
        "Collegare retention e skip alle decisioni di montaggio e proporre una V2 più informata. È roadmap esplicita, non una funzione dichiarata come attiva.",
      status: "Roadmap",
      icon: LineChart,
    },
  ],
