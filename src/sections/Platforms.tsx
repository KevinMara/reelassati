...
const PLATFORMS: {
  ...
  },
  {
    name: "Facebook",
    color: "#1877F2",
    path: "M256 128C256 57.308 198.692 0 128 0 57.308 0 0 57.308 0 128c0 63.888 46.8 116.84 108 126.445V165H75.5v-37H108V99.8c0-32.08 19.11-49.8 48.348-49.8C170.352 50 185 52.5 185 52.5V84h-16.14C152.959 84 148 93.867 148 103.99V128h35.476l-5.676 37H148v89.445c61.2-9.605 108-62.556 108-126.445z",
  },
  {
    name: "LinkedIn",
    color: "#0A66C2",
        ...
        <div className="mt-12 rounded-xl border border-border bg-surface p-6 md:p-8">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border pb-5">
            <p className="text-sm font-medium">
              {isItalian
                ? "Destinazioni supportate dal flusso di consegna"
                : "Targets supported by the delivery workflow"}
            </p>
            ...
            {deliveryTargets.map(platform => (
              ...
              >
                <div
                  ...
                  style={
                    platform.adaptive ? undefined : { color: platform.color }
                  }
                >
                  <svg
                    width="27"
