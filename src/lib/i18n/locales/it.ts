export default {
  ...
  "hero.time_saved": "Assistito, non automatico",

  // Marquee
  "marquee.neural_prediction": "Revisione basata su evidenze",
  "marquee.vertical_auto_edit": "Montaggio verticale revisionabile",
  "marquee.native_publishing": "Pubblicazione connessa",
  "marquee.synced_captions": "Sottotitoli sincronizzati",
  "marquee.tribe_v2": "TRIBE v2",
  "marquee.ab_testing": "Confronto versioni",
  "marquee.performance_analytics": "Analytics del workspace",
  "marquee.trend_detection": "Ipotesi trend",
  "marquee.multi_client": "Multi-client",
  "marquee.platforms": "Coda multi-piattaforma",
