export default {
  ...
  "hero.time_saved": "Assisted, not automatic",

  // Marquee
  "marquee.neural_prediction": "Evidence-led review",
  "marquee.vertical_auto_edit": "Reviewable vertical edit",
  "marquee.native_publishing": "Connected publishing",
  "marquee.synced_captions": "Synced captions",
  "marquee.tribe_v2": "TRIBE v2",
  "marquee.ab_testing": "Version comparison",
  "marquee.performance_analytics": "Workspace analytics",
  "marquee.trend_detection": "Trend hypotheses",
  "marquee.multi_client": "Multi-client",
  "marquee.platforms": "Multi-platform queue",
  ...
  "auth.signup.subtitle": "Continue with the authenticated site session.",
